...
parser.add_argument("--train", type=int, default=2_000_000, help="number of training timesteps")
parser.add_argument("--gui", action="store_true", help="enable GUI during evaluation")
parser.add_argument("--file", type=str, default="dqn_nav", help="agent name used for save filename")
parser.add_argument("--load", type=str, default=None, help="path to a saved model to skip training")
...
ax.set_ylabel("Rate (%)")
ax.set_title(f"Results over {total:,} episodes  |  avg reward: {avg_reward:.2f}")
ax.set_ylim(0, 110)
plt.tight_layout()
plt.show()
